...
<?php echo form_open('students/edited/'.$student['id']) ?>

	<div class="form-group">
    <label for="name">Full Name</label>
    <input type="input" name="name" value="<?php echo $student['name']; ?>" class="form-control" /><br />
	</div>

	<div class="form-group">
    <label for="address">Residence Address</label>
    <textarea name="address" class="form-control"><?php echo $student['address']; ?></textarea><br />
	</div>

	<div class="form-group">
    <label for="Male">Male</label>
    <input type="radio" name="gender" value="Male" <?php if ($student['gender'] == 'Male') { echo 'checked'; } ?> class="form-control">
	</div>

	<div class="form-group">	
    <label for="female">Female</label>
    <input type="radio" name="gender" value="Female" <?php if ($student['gender'] == 'Female') { echo 'checked'; } ?> class="form-control">
	</div>
